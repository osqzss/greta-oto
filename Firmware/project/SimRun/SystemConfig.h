...
#define OUTPUT_MASK_TRACKING_SWITCH OUTPUT_LEVEL_INFO
...
// configuration of measurements and PVT
...
#define DEFAULT_BB_MEAS_PORT 0
#define DEFAULT_BB_DATA_PORT 0
#define DEFAULT_NMEA_PORT 1
